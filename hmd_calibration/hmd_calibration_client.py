...
req.connect('tcp://127.0.0.1:59502')
...
def send_recv_notification(n):
    ...
    req.send_multipart((bytearray(str('notify.%s'%n['subject']).encode('UTF-8')), msgpack.dumps(n)))
    return req.recv()

def get_pupil_timestamp():
    #req.send('t') #this causes error...
    req.send_string('t') # I will try this code instead
    #see Pupil Remote Plugin for details
